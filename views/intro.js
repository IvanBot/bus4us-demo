	...
	var code_view = {
		cols:[
			{ css:"logo", borderless:true },
			{
				width:250, rows:[
				{ css:"logo", borderless:true },
				{ css:"logo", borderless:true, height:150, template:"<center><img id='main_logo2' src='assets/img/logo2.png'></center>" },
				{ css:"logo", borderless:true, height:50, template:"<center><img id='main_logo' src='assets/img/logo.png'></center>" },
				...
				{ css:"logo", borderless:true, view:"button", value:"Подтвердить", click: auth.send_code },
		...
		cols:[
			{ css:"logo", borderless:true },
			{
				width:250, rows:[
					...
					{ css:"logo", borderless:true, view:"button", value:"Получить код для входа", click: auth.send_number },
